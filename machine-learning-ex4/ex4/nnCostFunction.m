...
% Part 1b: Implement regularization with the cost function 
...
% Part 2b: Implement regularization with the gradient 
Theta1_grad(:, 1) = Theta1_grad(:, 1) ./ m;
Theta1_grad(:, 2:end) = Theta1_grad(:, 2:end) ./ m + ((lambda / m) * Theta1(:, 2:end)); %drop first
Theta2_grad(:, 1) = Theta2_grad(:, 1) ./ m;
Theta2_grad(:, 2:end) = Theta2_grad(:, 2:end) ./ m + ((lambda / m) * Theta2(:, 2:end)); %drop first


%Once the gradient computed, minimize the cost function J() using an
